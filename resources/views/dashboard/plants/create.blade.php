                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="english_name" name="english_name" rows="1" class="ckeditor form-control rounded-0">{{ old('english_name') ?? '' }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_regency" class="form-control" id="id_regency">
                                    ...
                                    @foreach ($regencies as $regency )
                                        <option value="{{ $regency->id }}" @if(old('id_regency') == $regency->id) selected @endif>{{ $regency->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_contributor" class="form-control" id="id_contributor">
                                    ...
                                    @foreach ($countributors as $countributor )
                                        <option value="{{ $countributor->id }}" @if(old('id_contributor') == $countributor->id) selected @endif>{{ $countributor->full_name }}</option>
                                    @endforeach
                                </select>
