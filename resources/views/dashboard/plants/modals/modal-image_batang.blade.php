<!-- Modal -->
<div class="modal fade" id="modalBatang" tabindex="-1" aria-labelledby="modalBatangLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="modalBatangLabel">Batang</h5>
            ...
            <form action="{{ route('dashboard.plants.update_images', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    @if(empty($data->image_batang))
                        <img src="{{ asset('images/plants/00-single.jpg') }}" alt="Image empty" class="border shadow w-100 mb-3" id="preview-image_batang">
                    @else
