                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    @if (!$data->photo)
                                    <img src="{{ asset('images/00.png') }}" alt="photo contributor" id="preview-gambar" class="img-thumbnail img-fluid w-100" >
                                    @else
                                    <img src="{{ asset('images/team/'.$data->photo) }}" alt="photo contributor" id="preview-gambar" class="img-thumbnail img-fluid w-100" >
                                    @endif
                                </div>
