                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="icon_name" name="icon_name" class="form-control rounded-0" placeholder="write Icon Name here">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <img src="{{ asset('images/00.png') }}" alt="Gambar" id="preview-gambar" class="img-thumbnail img-fluid" style="width:200px">
                                </div>
