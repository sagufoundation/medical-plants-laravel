        ...
        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            <div class="bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    ...
                    <span class="text-gray-500 dark:text-gray-400">Phytochemist</span>
                    <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Analyze the chemical properties of the plants and gather information on previous studies to provide a comprehensive understanding of each plant's medicinal properties.</p>
