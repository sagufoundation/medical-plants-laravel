    ...
    <div class="container mt-5 mb-5">
      <div class="row">
        <div class="col-12 text-center">
            <h1 class="fw-bolder font-satu"> How To Contribute</h1>
    ...
    <div class="container mt-5 mb-5">
      <div class="row text-center">
        <div class="col-lg-6">
            ...
            <h2 class="fw-bolder font-satu">For each individual or group of the local community in Papua </h2>
        ...
        <div class="col-lg-6">
            ...
            <h2 class="fw-bolder font-satu">Phytochemist, taxonomist, or ethnobotanist </h2>
