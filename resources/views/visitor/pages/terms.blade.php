    ...
    <div class="container mt-5 mb-5">
      ...
      <div class="row mb-5">
        <div class="col-lg-6 mx-auto text-center">
            <h1 class="fw-bolder font-satu text-success"> Terms and Conditions</h1>
            <p>These Terms and Conditions govern your use of our website and the contribution of traditional plant information through email. By using our website or submitting information, you agree to these terms.</p>
        </div>
      </div>
      ...
      <div class="row  align-self-center">
        <div class="col-lg-8 mx-auto p-5 border" style="text-align: justify">
            ...
            <p>2. You agree to use the website and its services for lawful and non-commercial purposes only.</p>
            ...
            <p>2. You grant us a non-exclusive, royalty-free, worldwide, and perpetual license to use, reproduce, distribute, and display the contributed information on our website.</p>
            ...
            <p>&nbsp; &nbsp;- Use the website in any way that could harm, disable, overburden, or impair our services.<br />
            &nbsp; &nbsp;- Use the website to engage in any illegal or unauthorized activity.<br />
            ...
            <p>By using our website or contributing traditional plant information via email, you agree to these Terms and Conditions. If you do not agree, please do not use our website or submit information.</p>
