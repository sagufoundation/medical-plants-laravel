...
<section class="bg-white dark:bg-gray-900 pb-16">
    ...
    <div class="gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 lg:px-6 py-9">
        <div>
            <img class="w-1/3 mx-auto rounded-lg dark:hidden" src="/assets/img/illustrations/2.png" alt="Illustration image">
            <img class="w-1/3 mx-auto rounded-lg hidden dark:block" src="/assets/img/illustrations/2-light.png" alt="Illustration image">
        ...
        <div>
            <img class="w-1/3 mx-auto rounded-lg dark:hidden" src="/assets/img/illustrations/3.png" alt="Illustration image">
            <img class="w-1/3 mx-auto rounded-lg hidden dark:block" src="/assets/img/illustrations/3-light.png" alt="Illustration image">
