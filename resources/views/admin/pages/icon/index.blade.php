...
<section>
    <div class="py-8 px-4 ml-64 lg:py-16 lg:px-6">
        ...
        <a href="{{route('admin.icon.create')}}" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 mb-5 hover:shadow-lg transition">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="col" class="px-6 py-3 flex gap-1">
                                ...
                                <a href="{{ route('admin.icon.edit', $data->id)}}" class="border border-green-800 text-green-800 hover:bg-green-800 hover:text-white px-3 py-2 rounded transition"><i class="fa-solid fa-pencil"></i></a>
