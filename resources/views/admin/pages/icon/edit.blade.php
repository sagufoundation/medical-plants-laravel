...
@extends('admin.layouts.admin-app')
    @section('title')
    Icon Edit - Admin Traditional Medicinal Plants in Papua
    @endsection
@section('content')
    ...
    <div class="p-10 mt-8 px-4 ml-64 lg:py-16 lg:px-6">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div class="md:w-2/3">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" enctype="multipart/form-data" action="{{route('admin.icon.update', $data->id)}}">
                    @csrf
                    @method('put')
                    <div>
                        ...
                        <input type="icon_name" name="icon_name" id="icon_name"
                            ...
                            placeholder="" required="" value="{{old('icon_name') ? old('icon_name') : $data->icon_name }}" >
                    ...
                    <div>
                        ...
                        <img src="{{url($data->icon_img)}}" class="w-52 mb-5" alt="{{$data->icon_name}}" srcset="">
