            ...
            <ul class="space-y-2 lg:pt-16">
                ...
                <li>
                    <button type="button"
                        ...
                        <svg aria-hidden="@if(Request::segment(2) != 'plant')) true @endif" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                ...
                <li>
                    <button type="button"
                        ...
                        <svg aria-hidden="@if(Request::segment(2) != 'location')) true @endif" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="{{route('admin.setting')}}"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group cursor-pointer">
                        <span
                            class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white">
