...
class PlantSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $plant = Plant::create([
            ...
            'id_contributor' => 1,
            'id_province' => 1,
            'cover_picture' => 'sample/3.png',
            'gallery_picture' => 'sample/3-gallery.png',
            'local_name' => 'Anamyaum',
            'indonesian_name' => '-',
        ...
        $plant = Plant::create([
            ...
            'id_contributor' => 1,
            'id_province' => 1,
            'cover_picture' => 'sample/2.png',
            'gallery_picture' => 'sample/2-gallery.png',
        ...
        $plant = Plant::create([
            ...
            'id_contributor' => 1,
            'id_province' => 1,
            'cover_picture' => 'sample/1.png',
            'gallery_picture' => 'sample/1-gallery.png',
